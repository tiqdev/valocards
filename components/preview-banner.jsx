...
const BannerPreview = () => {
  ...
  return (
    <div className="w-[600px]  flex flex-row gap-1">
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="h-[31px] w-full mt-[1px] relative bg-[#0F1820] tracking-wide">
          <h3 className="absolute bottom-[5px] left-1/2 -translate-x-1/2 z-20 font-normal text-[11px] text-[#888E93]">
            {banner.title}
          </h3>
          <h1 className="absolute bottom-[0px] left-[6px] z-20 font-medium text-[20px] text-white opacity-90">
            {banner.username}
          </h1>
          <h2 className="absolute bottom-[6px] right-[6px]  z-20 font-normal text-[11px] text-[#888E93]">
            {banner.agentName}
          </h2>
        </div>
      </div>
